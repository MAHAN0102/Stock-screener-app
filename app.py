...
st.write("માર્કેટના દરેક શેરનું પ્રોફેશનલ ક્વોન્ટ એનાલિસિસ (FII મોડેલ) - લાઈવ")
...
with st.spinner('માર્કેટ ડેટા ફેચ થઈ રહ્યો છે... (કૃપા કરીને રાહ જુઓ)'):
...
if not df.empty:
    ...
    st.info("💡 નોંધ: મોબાઈલ સ્ક્રીન નાની હોવાથી બધો ડેટા જોવા માટે ટેબલની અંદર આંગળીથી ડાબી-જમણી બાજુ સ્લાઈડ (Scroll) કરવું.")
